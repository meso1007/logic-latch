...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.message || t("signupFailedTryAgain"));
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="w-full max-w-[1600px] grid lg:grid-cols-2 gap-8 lg:gap-20 items-stretch">
                    ...
                    >
                        ...
                        <div className="relative z-10 p-12 flex flex-col justify-end h-full w-full">
                            ...
                            >
                                {String(t("startJourney"))}<br />
                                <span className="text-[#10b981]">{String(t("journey"))}</span>
                            </motion.h1>
                            <motion.p
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                        ...
                        >
                            ...
                            <motion.div variants={itemVariants} className="mb-8">
                                ...
                                <div className="mt-4 text-sm text-slate-500">
                                    {t("hasAccount")} <a href="/login" className="text-[#10b981] hover:underline font-bold transition-all hover:text-[#34d399]">{t("loginButton")}</a>
                                </div>
                            </motion.div>
